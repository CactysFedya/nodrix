...
from ..adapters import odometry_to_frame, point_cloud2_to_frame
from ..common import (
...
class Ros2PointCloud2Source(_TopicSourceBase):
    ...
    output_types = {"cloud": "mapping.point_cloud/v1"}
    output_port = "cloud"
    nodrix_type = "mapping.point_cloud/v1"
...
class Ros2OdometrySource(_TopicSourceBase):
    ...
    output_types = {"odometry": "geometry.odometry/v1"}
    output_port = "odometry"
    nodrix_type = "geometry.odometry/v1"
